...
/////////////////////////////////////////////////
LinkAttacher::LinkAttacher(ModelPtr _model) :
  nh_("gazebo_link_attacher")
{
  this->model = _model;
...
/////////////////////////////////////////////////
void LinkAttacher::Load(sdf::ElementPtr _sdf)
{
...
//  this->detachSteps = graspCheck->Get<int>("detach_steps");
  ...
  this->attacher_sub_ = this->nh_.subscribe("link_attacher", 1, &GazeboRosLinkAttacher::set_attach_callback, this);
...
//          &LinkAttacher::OnContacts, this);
//    }
//  }
//  this->connections.push_back(event::Events::ConnectWorldUpdateEnd(
//          boost::bind(&LinkAttacher::OnUpdate, this)));
}

/////////////////////////////////////////////////
void LinkAttacher::Init()
{
...
/////////////////////////////////////////////////
void LinkAttacher::HandleAttach()
{
  ROS_INFO_STREAM("Trying to attach " << this->object_name);
  this->world->GetByName(this->object_name);
...
/////////////////////////////////////////////////
void LinkAttacher::HandleDetach()
{
  this->attached = false;
...
/////////////////////////////////////////////////
void LinkAttacher::OnContacts(ConstContactsPtr &_msg)
{
...
/////////////////////////////////////////////////
void LinkAttacher::ResetDiffs()
{
//  for (unsigned int i = 0; i < 10; ++i)
  //    this->diffs[i] = GZ_DBL_MAX;
}

void LinkAttacher::set_attach_callback(const std_msgs::String &msg)
{
  this->object_name = msg.data;
  this->HandleAttach();
}

/////////////////////////////////////////////////
std::string LinkAttacher::GetName() const
{
  return this->name;
}

/////////////////////////////////////////////////
bool LinkAttacher::IsAttached() const
{
