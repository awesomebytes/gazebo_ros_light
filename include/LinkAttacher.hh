...
namespace gazebo
{
  namespace physics
  {
    ...
    /// \class LinkAttacher LinkAttacher.hh physics/physics.hh
    ...
    class GAZEBO_VISIBLE LinkAttacher
    {
      /// \brief Constructor
      /// \param[in] _model The model which contains the LinkAttacher.
      public: explicit LinkAttacher(ModelPtr _model);

      /// \brief Destructor.
      public: virtual ~LinkAttacher();
      ...
      private: std::string object_name;
      ...
      private: ros::Subscriber attacher_sub_;

      void set_attach_callback(const std_msgs::String& msg);
    };
    /// \}
  }
}
